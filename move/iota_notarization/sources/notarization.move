...
public fun state_data<D: store + drop + copy>(self: &Notarization<D>): &D { &self.state.data }

public fun state_metadata<D: store + drop + copy>(self: &Notarization<D>): &Option<String> {
    &self.state.metadata
}
